...
# // Banner
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e " Wellcome To Script Versi 2024 ${NC}"
echo -e " Versi Gratis Life-Time ${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
sleep 2 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/AsepSabath/halu/main/"
...
echo -e " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e " \e[1;32m1)\e[0m Menggunakan Domain Sendiri (Selain Do)"
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    wget -O /etc/haproxy/haproxy.cfg "${REPO}v1/haproxy.cfg" >/dev/null 2>&1
    wget -O /etc/nginx/conf.d/xray.conf "${REPO}v1/xray.conf" >/dev/null 2>&1
    sed -i "s/xxx/${domain}/g" /etc/haproxy/haproxy.cfg
    sed -i "s/xxx/${domain}/g" /etc/nginx/conf.d/xray.conf
    curl ${REPO}v1/nginx.conf > /etc/nginx/nginx.conf
...
function udp_mini(){
clear
print_install "Memasang Service"
...
clear
# // Installing UDP Mini
print_install "Memasang Server"
 print_success "Lanjut"
}
...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "${REPO}v1/rclone.conf"
...
gotop_latest="$(curl -s https://api.github.com/repos/xxxserxxx/gotop/releases | grep tag_name | sed -E 's/.*"v(.*)".*/\1/' | head -n 1)"
    ...
    wget https://raw.githubusercontent.com/Arya-Blitar22/st-pusat/main/media/bbr.sh &&  chmod +x bbr.sh && ./bbr.sh
...
print_success "Oke Siap Brow"
}

function ins_epro(){
clear
print_install "Menginstall ePro WebSocket Proxy"
    wget -O /usr/bin/ws "https://raw.githubusercontent.com/Arya-Blitar22/bokep2/main/v1/ws" >/dev/null 2>&1
    wget -O /usr/bin/tun.conf "${REPO}v1/tun.conf" >/dev/null 2>&1
    wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/Arya-Blitar22/bokep2/main/v1/ws.service" >/dev/null 2>&1
